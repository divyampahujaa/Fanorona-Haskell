...
import Dragons.Fanorona (toAITable, rules1100, rules1130)
import Dragons.Fanorona.CodeWorld (codeWorldUI)
import Dragons.Fanorona.Text (textUI)
...
appMain = do
  ...
  let
    ...
    rules = (case optMode options of
      COMP1100 -> rules1100
      COMP1130 -> rules1130) (optHeight options) (optWidth options)
